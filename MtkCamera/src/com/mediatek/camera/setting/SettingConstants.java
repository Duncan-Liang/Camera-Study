...
public class SettingConstants {
    ...
    public static final int SETTING_COUNT = 61;//lifeifei@wind-mobi.com double camera begin
    // setting key
    public static final String KEY_CAMERA_ID                 = "pref_camera_id_key";
    //lifeifei@wind-mobi.com double camera begin
    public static final String KEY_CAMERA_ID_2                 = "pref_camera_id_key_2";
    //lifeifei@wind-mobi.com double camera end
    ...
    public static final int ROW_SETTING_DUAL_CAMERA_2               = 60; //common//lifeifei@wind-mobi.com double camera begin
    ...
    static {
        ...
        SETTING_TYPE[ROW_SETTING_DUAL_CAMERA_2]               = ONLY_IN_PEFERENCE;//lifeifei@wind-mobi.com double camera begin
    ...
    static {
        ...
        KEYS_FOR_SETTING[ROW_SETTING_DUAL_CAMERA_2]           = KEY_CAMERA_ID_2;//lifeifei@wind-mobi.com double camera begin
