...
public class SettingGenerator {
    ...
    private boolean filterPreference(final ListPreference preference) {
        ...
        case SettingConstants.ROW_SETTING_PICTURE_SIZE:// camera special case
            ...
            if (parameters.get("refocus-picture-size") != null) {
                supportedPictureSizes.add(parameters.get("refocus-picture-size"));
            }
        ...
        Log.i(TAG, "[filterPreference], key:" + key + "," +
    ...
    private void limitPreferencesByIntent() {
        ...
        int currentCameraId = mICameraDeviceManager.getCurrentCameraId();
        Log.i(TAG, "currentCameraId:" + currentCameraId + ", frontCameraId:" +
    ...
    private boolean isCFBSupported() {
        boolean support = mICameraDevice.getParameters().getSupportedCaptureMode()
                .indexOf(Parameters.CAPTURE_MODE_FB) >= 0;
        Log.i(TAG, "isCFBSupported = " + support);
        return support;
    }
