...
public class ComboPreferences implements SharedPreferences, OnSharedPreferenceChangeListener {
    ...
    public ComboPreferences(Context context, boolean isSecureCamera) {
    ...
    public void setLocalId(Context context, int cameraId) {
        ...
        if (mIsSecureCamera) {
            prefName = context.getPackageName() + "_preferences_secure" + cameraId;
        }
    ...
    public SharedPreferences getSharedPreference(Context context, int cameraId) {
        String prefName = context.getPackageName() + "_preferences_" + cameraId;
        if (mIsSecureCamera) {
            prefName = context.getPackageName() + "_preferences_secure" + cameraId;
        }
    ...
    private static boolean isGlobal(String key) {
        return key.equals(SettingConstants.KEY_CAMERA_ID)
                || key.equals(SettingConstants.KEY_CAMERA_ID_2) //lifeifei@wind-mobi.com double camera begin
    ...
    @Override
    public void registerOnSharedPreferenceChangeListener(OnSharedPreferenceChangeListener ls) {
        mListeners.add(ls);
    }

    @Override
    public void unregisterOnSharedPreferenceChangeListener(OnSharedPreferenceChangeListener ls) {
