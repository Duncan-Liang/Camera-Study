...
public class CameraHolder {
    ...
    private int mBackCameraId2 = UNKONW_ID;
   ...
   // lifeifei@wind-mobi.com for double camera begin
    private static CameraProxyWrapper sBackCamProxyWrapper2;
    private static CameraManager sBackCameraManager2;
   // lifeifei@wind-mobi.com for double camera end
    ...
    private CameraHolder() {
        ...
        for (int i = 0; i < mNumberOfCameras; i++) {
            ...
            // lifeifei@wind-mobi.com for double camera begin
            } else if (mBackCameraId2 == UNKONW_ID
                    && mInfo[i].facing == CameraInfo.CAMERA_FACING_BACK) {
                //mobify by huangzhijian@wind-mobi.com  for change cameraid 
                //mBackCameraId2 = 2;
                mBackCameraId2 = i;
                sBackCameraManager2 = new CameraManager("BackCam2");
                sBackCamProxyWrapper2 = new CameraProxyWrapper(mBackCameraId2, sBackCameraManager2);
            }
            // lifeifei@wind-mobi.com for double camera end
        }
    }
    ...
    public void release(boolean isAsync) {
        ...
        // lifeifei@wind-mobi.com for double camera begin
        if (getCameraProxyWrapper(mBackCameraId2).getCameraProxy() != null) {
            Log.i(TAG, "CameraHolder release back2 camera");
            getCameraProxyWrapper(mBackCameraId2).release(isAsync);
        }
        // lifeifei@wind-mobi.com for double camera end
    }
    ...
    private CameraProxyWrapper getCameraProxyWrapper(int cameraId) {
        ...
        // lifeifei@wind-mobi.com for double camera begin
        }  else if(cameraId == mBackCameraId2){
            if (sBackCamProxyWrapper2 == null) {
                sBackCameraManager2 = new CameraManager("BackCam2");
                sBackCamProxyWrapper2 = new CameraProxyWrapper(cameraId, sBackCameraManager2);
            }
            return sBackCamProxyWrapper2;
        // lifeifei@wind-mobi.com for double camera end
        } else {
