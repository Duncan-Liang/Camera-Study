...
public class ModeChecker {
    ...
    static {
        ...
        // back front
        // lifeifei@wind-mobi.com for double camera begin
        MATRIX_NORMAL_ENABLE[ModePicker.MODE_PHOTO] = new boolean[] { true, true,true };
        MATRIX_NORMAL_ENABLE[ModePicker.MODE_HDR] = new boolean[] { true, false,true };
        MATRIX_NORMAL_ENABLE[ModePicker.MODE_FACE_BEAUTY] = new boolean[] { true, true,true };
        MATRIX_NORMAL_ENABLE[ModePicker.MODE_PANORAMA] = new boolean[] { true, false,true };
        MATRIX_NORMAL_ENABLE[ModePicker.MODE_ASD] = new boolean[] { true, false,true };
        MATRIX_NORMAL_ENABLE[ModePicker.MODE_VIDEO] = new boolean[] { true, true,true };
        MATRIX_NORMAL_ENABLE[ModePicker.MODE_PHOTO_PIP] = new boolean[] { true, true,true };
        MATRIX_NORMAL_ENABLE[ModePicker.MODE_VIDEO_PIP] = new boolean[] { false, false,false };
        MATRIX_NORMAL_ENABLE[ModePicker.MODE_STEREO_CAMERA]     = new boolean[]{true, false,true};
        MATRIX_NORMAL_ENABLE[ModePicker.MODE_VIDEO_STEREO]     = new boolean[]{true, false,true};

        MATRIX_PREVIEW3D_ENABLE[ModePicker.MODE_PHOTO] = new boolean[] { true, false,true };
        MATRIX_PREVIEW3D_ENABLE[ModePicker.MODE_HDR] = new boolean[] { false, false,false  };
        MATRIX_PREVIEW3D_ENABLE[ModePicker.MODE_FACE_BEAUTY] = new boolean[] { false, false ,false };
        MATRIX_PREVIEW3D_ENABLE[ModePicker.MODE_PANORAMA] = new boolean[] { false, false,false };
        MATRIX_PREVIEW3D_ENABLE[ModePicker.MODE_ASD] = new boolean[] { false, false,false  };
        MATRIX_PREVIEW3D_ENABLE[ModePicker.MODE_VIDEO] = new boolean[] { true, false,true };
        MATRIX_PREVIEW3D_ENABLE[ModePicker.MODE_PHOTO_PIP] = new boolean[] { false, false,false  };

        MATRIX_SINGLE3D_ENABLE[ModePicker.MODE_PHOTO] = new boolean[] { true, false,true };
        MATRIX_SINGLE3D_ENABLE[ModePicker.MODE_HDR] = new boolean[] { false, false,false  };
        MATRIX_SINGLE3D_ENABLE[ModePicker.MODE_FACE_BEAUTY] = new boolean[] { false, false,false  };
        MATRIX_SINGLE3D_ENABLE[ModePicker.MODE_PANORAMA] = new boolean[] { true, false,true };
        MATRIX_SINGLE3D_ENABLE[ModePicker.MODE_ASD] = new boolean[] { false, false,false  };
        MATRIX_SINGLE3D_ENABLE[ModePicker.MODE_VIDEO] = new boolean[] { false, false,false  };
        MATRIX_SINGLE3D_ENABLE[ModePicker.MODE_PHOTO_PIP] = new boolean[] { false, false,false  };
        // lifeifei@wind-mobi.com for double camera end
    }
    ...
    public static void updateModeMatrix(CameraActivity camera, int cameraId) {
        ...
        // if back camera not support cfb, front camera also not support.other wise switch to
        // front camera will so cfb capture icon in the mode picker area.
        if (!MATRIX_NORMAL_ENABLE[ModePicker.MODE_FACE_BEAUTY][0]) {
            MATRIX_NORMAL_ENABLE[ModePicker.MODE_FACE_BEAUTY][1] = false;
        }
    }
